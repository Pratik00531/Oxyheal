...
const Signup = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    toast({
      ...
      description: "Welcome to OxyHeal. Please log in to continue.",
    });
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-light via-background to-accent flex items-center justify-center p-4">
      <Card className="w-full max-w-md p-8 gradient-card shadow-medium">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-display font-bold text-primary mb-2">Join OxyHeal</h1>
          <p className="text-muted-foreground">Start your journey to better breathing</p>
        </div>
